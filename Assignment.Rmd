...
thetabias <- Model3_thetahat[1] #selected parameter
thetaone <- Model3_thetahat[2] # selected parameter
thetatwo <- Model3_thetahat[3] # constant value
thetathree <- Model3_thetahat[4] # constant value
