...
thetabias <- abs(Model3_thetahat[1]) #selected parameter
thetaone <- abs(Model3_thetahat[2]) # selected parameter
thetatwo <- abs(Model3_thetahat[3]) # constant value
thetathree <- abs(Model3_thetahat[4]) # constant value


Epison <- RSS_Model_3 * 2 ## fixing value of epison
...
for (i in 1:num) {
  ...
  New_Y_Hat <- X_model3 %*% New_thetahat ## calculating new Y-hat
